...
class VolunteerApplicationForm(forms.ModelForm):
    ...
    education_or_experience = forms.CharField(widget=forms.Textarea(attrs={"class":"form-control", "placeholder":"Add your resume here. 700 words max.", "rows":"7"}))
    ...
    date_of_travel = forms.DateField(widget=forms.DateInput(attrs={"class":"form-control", "id":"datepicker2", "placeholder":"mm/dd/yyyy"}))
    do_you_require_further_information = forms.CharField(widget=forms.Textarea(attrs={"class":"form-control", "placeholder":"Type here...", "rows":"3"}))
    how_did_you_hear_about_us = forms.ChoiceField(choices=HOW_DID_YOU_HEAR_ABOUT_US, widget=forms.Select(attrs={"class":"form-control"}))
    any_other_comments = forms.CharField(widget=forms.Textarea(attrs={"class":"form-control", "placeholder":"Type here...", "rows":"3"}))

    emergency_contact_full_name = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Full Name", "class":"form-control"}))
    emergency_contact_telephone_no = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Telephone No.", "class":"form-control"}))
    emergency_contact_residential_address = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Residential Address", "class":"form-control"}))
    emergency_contact_relationship = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Relationship", "class":"form-control"}))

    referee_contact_full_name = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Full Name", "class":"form-control"}))
    referee_contact_organization = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Organization", "class":"form-control"}))
    referee_contact_telephone_no = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Telephone No.", "class":"form-control"}))
    referee_contact_work_address = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Work Address", "class":"form-control"}))
